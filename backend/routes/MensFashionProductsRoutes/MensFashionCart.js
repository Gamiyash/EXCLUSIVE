...
router.post('/addToCartMensFashionProducts', async (req, res) => {
    try {
        ...
        const product = await MensFashion.findById(productId);
        if (!product) {
...
router.get('/getMensFashionProductsDetails/:email', async (req, res) => {
    try {
