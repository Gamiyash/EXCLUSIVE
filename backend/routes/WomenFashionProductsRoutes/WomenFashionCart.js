...
router.post('/addToCartWomenFashionProducts', async (req, res) => {
    try {
        ...
        const product = await WomenFashion.findById(productId);
        if (!product) {
...
router.get('/getWomenFashionProductsDetails/:email', async (req, res) => {
    try {
