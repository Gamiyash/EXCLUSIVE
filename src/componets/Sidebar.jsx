...
const Sidebar = () => {
    ...
    return (
        <>
            <div className='relative m-3 lg:hidden block' ref={dropdownRef}>
                <RxHamburgerMenu onClick={handleButtonbgchange} size={40} />
            </div>

            <div className="sidebar pl-[10%] lg:flex hidden">
                    <ul className='flex flex-col font-medium mt-8'>

                        <Link to={"/WomenFashionProducts"} className="block px-4 py-2  text-[#FFFFFF flex items-center gap-3 xl:hover:bg-gray-200 hover:bg-gray-700 hover:rounded">
                            Woman's Fashion
                        ...
                        <Link to={"/MensFashionProducts"} className="block px-4 py-2 text-[#FFFFFF flex items-center gap-3 xl:hover:bg-gray-200 hover:bg-gray-700 hover:rounded">
                            Man's Fashion
                            <span className="opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
                                <FaAngleRight />
                            </span>
                        ...
                        <Link to={"/Electronics"} className="block px-4 py-2 text-[#FFFFFF flex items-center gap-3 xl:hover:bg-gray-200 hover:bg-gray-700 hover:rounded">
                            Electronics
                            <span className="opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
                                <FaAngleRight />
                            </span>
                        ...
                        <li className="block px-4 py-2 text-[#FFFFFF flex items-center gap-3 xl:hover:bg-gray-200 hover:bg-gray-700 hover:rounded">
                            Home & Lifestyle
                            <span className="opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
                                <FaAngleRight />
                            </span>
