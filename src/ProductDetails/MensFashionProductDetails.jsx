...
const MensFashionProductDetails = ({ user, productId, data }) => {
    const { id } = useParams();
    ...
    const handleBuyNow = async () => {
        ...
        try {
            ...
            await axios.post('http://localhost:3000/api/addToCartMensFashionProducts', {
                email: username,
    ...
    const handleCommentSubmit = async () => {
        ...
        try {
            await axios.post(`http://localhost:3000/api/MensFashion/${id}/comments`, {
                email: user.email,
                comment: newComment
            }, {
                withCredentials: true
            ...
            const commentsResponse = await axios.get(`http://localhost:3000/api/MensFashion/${id}/comments`);
            setComments(commentsResponse.data);
        } catch (error) {
    ...
    const handleCommentDelete = async (commentId) => {
        ...
        try {
            await axios.delete(`http://localhost:3000/api/MensFashion/${id}/comments/${commentId}`);
            const response = await axios.get(`http://localhost:3000/api/MensFashion/${id}/comments`);
...
export default MensFashionProductDetails;
