...
const ThisMonthBestProductsDetails = ({ user, productId }) => {
    const { id } = useParams();
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/Thismonth/${id}`);
                setProduct(response.data);
                setMainImage(response.data.image);
                // Fetch comments
                const commentsResponse = await axios.get(`${import.meta.env.VITE_API_URL}/api/Thismonth/${id}/comments`);
    ...
    const handleBuyNow = async () => {
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_API_URL}/api/addToCartThismonthBestProducts`, payload, {
                withCredentials: true
            });

            // await axios.post('${import.meta.env.VITE_API_URL}/api/Checkout', payload, {
            //     withCredentials: true
            // });
        ...
        // try {
        //     const username = user.email;
        //     await axios.post('${import.meta.env.VITE_API_URL}/api/addToCartThismonthBestProducts', {
        //         email: username,
    ...
    const handleCommentSubmit = async () => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL}/api/Thismonth/${id}/comments`, {
                email: user.email,
                comment: newComment
            }, {
                withCredentials: true
    ...
    const handleCommentDelete = async (commentId) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL}/api/Thismonth/${id}/comments/${commentId}`);
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/Thismonth/${id}/comments`);
...
export default ThisMonthBestProductsDetails;
