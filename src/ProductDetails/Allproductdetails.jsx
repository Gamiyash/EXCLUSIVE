...
const AllProductDetails = ({ user, productId }) => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                // Fetch comments
                const commentsResponse = await axios.get(`${import.meta.env.VITE_API_URL}/api/products/${id}/comments`);
    ...
    const handleBuyNow = async () => {
        ...
        if (user) {
            try {
                ...
                await axios.post(`${import.meta.env.VITE_API_URL}/api/addToCartallproduct`, payload, {
    ...
    const handleCommentSubmit = async () => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL}/api/products/${id}/comments`, {
                email: user.email,
                comment: newComment
            }, {
                withCredentials: true
    ...
    const handleCommentDelete = async (commentId) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL}/api/products/${id}/comments/${commentId}`);
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/products/${id}/comments`);
    ...
    const AddtoWishList = async () => {
        if (user) {
            try {
                ...
                await axios.post(`${import.meta.env.VITE_API_URL}/api/addToWishList`, payload1, {
                    withCredentials: true
                });
