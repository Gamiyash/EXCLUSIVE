...
const FlashProductDetails = ({ user, productId }) => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/Flashproducts/${id}`);
                setProduct(response.data);
                setMainImage(response.data.image);
                // Fetch comments
                const commentsResponse = await axios.get(`${import.meta.env.VITE_API_URL}/api/Flashproducts/${id}/comments`);
    ...
    const handleBuyNow = async () => {
        ...
        //     await axios.post('${import.meta.env.VITE_API_URL}/api/addToCart', {
        //         email: username,
        ...
        try {
            ...
            await axios.post(`${import.meta.env.VITE_API_URL}/api/addToCart`, payload, {
                withCredentials: true
            });
    ...
    const handleCommentSubmit = async () => {
        ...
        try {
            await axios.post(`${import.meta.env.VITE_API_URL}/api/Flashproducts/${id}/comments`, {
                email: user.email,
                comment: newComment
            }, {
                withCredentials: true
    ...
    const handleCommentDelete = async (commentId) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL}/api/Flashproducts/${id}/comments/${commentId}`);
            const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/Flashproducts/${id}/comments`);
    ...
    return (
        <>
            <div className='Main flex w-[100vw] gap-10 xl:h-[80vh] h-[40vh]'>
