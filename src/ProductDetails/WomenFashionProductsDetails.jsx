...
const WomenFashionProductDetails = ({ user, productId, data }) => {
    const { id } = useParams();
    ...
    const handleBuyNow = async () => {
        ...
        try {
            ...
            await axios.post('http://localhost:3000/api/addToCartWomenFashionProducts', {
                email: username,
    ...
    const handleCommentSubmit = async () => {
        ...
        try {
            await axios.post(`http://localhost:3000/api/WomenFashion/${id}/comments`, {
                email: user.email,
                comment: newComment
            }, {
                withCredentials: true
            ...
            const commentsResponse = await axios.get(`http://localhost:3000/api/WomenFashion/${id}/comments`);
            setComments(commentsResponse.data);
        } catch (error) {
    ...
    const handleCommentDelete = async (commentId) => {
        ...
        try {
            await axios.delete(`http://localhost:3000/api/WomenFashion/${id}/comments/${commentId}`);
            const response = await axios.get(`http://localhost:3000/api/WomenFashion/${id}/comments`);
    ...
    const { name, actualPrice, discount, image, offerPrice, rating, discription, size, sideimg1, sideimg2, sideimg3, sideimg4 } = product;
        ...
        <>
            <div className='Main flex w-[100vw]'>
                ...
                <div className="details mt-20 flex flex-col justify-start gap-3 w-[30vw]">
                    ...
                    <div className="offerprice flex items-center gap-2 text-xl">
                        <div className='flex items-center text-xl'> <FaIndianRupeeSign size={17} />{offerPrice}</div>
                        <div className='flex items-center text-xl line-through text-gray-400'> <FaIndianRupeeSign size={17} />{actualPrice}</div>
                        <div className='flex items-center font-medium text-xl text-green-500'> {discount}% off</div>
                    </div>
            ...
            <div className="allproducts flex flex-col pl-10 pt-10 gap-9">
                ...
                <div
                    ...
                    <div>
                        <div className="product-list flex justify-around mt-5 gap-3 ">
...
export default WomenFashionProductDetails;
