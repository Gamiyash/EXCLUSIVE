...
function Dashboard() {
    ...
    useEffect(() => {
        const FetchUsers = async () => {
            try {
                const responce = await axios.get(`${import.meta.env.VITE_API_URL}/api/getAllUsers`);
    ...
    useEffect(() => {
        const FetchOrders = async () => {
            try {
                const responce = await axios.get(`${import.meta.env.VITE_API_URL}/api/getOrdersForAdmin`);
    ...
    useEffect(() => {
        const fetchSalesData = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/salesData`);
    ...
    useEffect(() => {
        const fetchTotalRevenue = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/totalRevenue`);
    ...
    useEffect(() => {
        const fetchMonthlyRevenue = async () => {
            try {
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/monthlyRevenue`);
