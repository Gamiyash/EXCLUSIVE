...
const Checkout = () => {
    ...
    const createRazorpayOrder = async () => {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/createOrder`, {
        ...
        const options = {
            ...
            handler: async (response) => {
                ...
                try {
                    ...
                    const verificationResponse = await axios.post(`${import.meta.env.VITE_API_URL}/api/verifyPayment`, {
    ...
    useEffect(() => {
        const fetchCartData = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/getAllProductsCheckoutData/${userEmail}`);
    ...
    useEffect(() => {
        const fetchCartData = async () => {
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/getFlashProductsCheckoutData/${userEmail}`);
                setCheckoutItems(response.data);
            } catch (err) {
                // setErrors(err.message);
            } finally {
    ...
    useEffect(() => {
        const fetchCartData = async () => {
            try {
                const userEmail = JSON.parse(localStorage.getItem('user'))?.email; // Replace with actual email logic or context
                const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/getThisMonthBestProductsCheckoutData/${userEmail}`);
                setCheckoutItems(response.data);
            } catch (err) {
                // setErrors(err.message);
            } finally {
