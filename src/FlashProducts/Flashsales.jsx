...
const Flashslaes = ({ FlashProduct, user }) => {
    ...
    return (
        ...
        <div className="card p-2 xl:w-[180px] w-[120px] h-full flex flex-col items-start justify-start relative hover:bg-[#ffff] hover:scale-105 transition-transform hover:shadow-md "
